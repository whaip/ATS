#ifndef SWITCHTPSPLUGIN_H
#define SWITCHTPSPLUGIN_H

#include <QObject>

#include "../Core/tpsplugininterface.h"

// 开关元件的 TPS 插件框架，负责定义策略参数和资源需求。
class SwitchTpsPlugin : public QObject, public TPSPluginInterface
{
    Q_OBJECT
    Q_INTERFACES(TPSPluginInterface)

public:
    explicit SwitchTpsPlugin(QObject *parent = nullptr);
