#ifndef POTENTIOMETERTPSPLUGIN_H
#define POTENTIOMETERTPSPLUGIN_H

#include <QObject>

#include "../Core/tpsplugininterface.h"

// 电位器元件的 TPS 插件框架，负责定义策略参数和资源需求。
class PotentiometerTpsPlugin : public QObject, public TPSPluginInterface
{
    Q_OBJECT
    Q_INTERFACES(TPSPluginInterface)

public:
    explicit PotentiometerTpsPlugin(QObject *parent = nullptr);
...
#endif // POTENTIOMETERTPSPLUGIN_H
