...
ICDiagnosticPlugin::ICDiagnosticPlugin(QObject *parent)
    : QObject(parent)
{
}

QString ICDiagnosticPlugin::pluginId() const
{
    return QStringLiteral("diag.ic");
}

QString ICDiagnosticPlugin::displayName() const
{
    return QStringLiteral("IC Diagnostic");
}

QString ICDiagnosticPlugin::version() const
{
    return QStringLiteral("1.0.0");
}

QString ICDiagnosticPlugin::componentType() const
{
    return QStringLiteral("tps.ic");
}

DiagnosticReport ICDiagnosticPlugin::diagnose(const DiagnosticInput &input, QString *error) const
{
    ...
    QStringList lines;
    lines.push_back(QStringLiteral("IC diagnostic framework created."));
