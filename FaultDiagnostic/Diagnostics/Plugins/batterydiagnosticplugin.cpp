#include "batterydiagnosticplugin.h"
...
BatteryDiagnosticPlugin::BatteryDiagnosticPlugin(QObject *parent)
    : QObject(parent)
{
}

QString BatteryDiagnosticPlugin::pluginId() const
{
    return QStringLiteral("diag.battery");
}

QString BatteryDiagnosticPlugin::displayName() const
{
    return QStringLiteral("Battery Diagnostic");
}

QString BatteryDiagnosticPlugin::version() const
{
    return QStringLiteral("1.0.0");
}

QString BatteryDiagnosticPlugin::componentType() const
{
    return QStringLiteral("tps.battery");
}

DiagnosticReport BatteryDiagnosticPlugin::diagnose(const DiagnosticInput &input, QString *error) const
{
    ...
    QStringList lines;
    lines.push_back(QStringLiteral("battery diagnostic framework created."));
