#include "switchdiagnosticplugin.h"
...
SwitchDiagnosticPlugin::SwitchDiagnosticPlugin(QObject *parent)
    : QObject(parent)
{
}

QString SwitchDiagnosticPlugin::pluginId() const
{
    return QStringLiteral("diag.switch");
}

QString SwitchDiagnosticPlugin::displayName() const
{
    return QStringLiteral("Switch Diagnostic");
}

QString SwitchDiagnosticPlugin::version() const
{
    return QStringLiteral("1.0.0");
}

QString SwitchDiagnosticPlugin::componentType() const
{
    return QStringLiteral("tps.switch");
}

DiagnosticReport SwitchDiagnosticPlugin::diagnose(const DiagnosticInput &input, QString *error) const
{
    ...
    QStringList lines;
    lines.push_back(QStringLiteral("switch diagnostic framework created."));
