#include "buzzerdiagnosticplugin.h"
...
BuzzerDiagnosticPlugin::BuzzerDiagnosticPlugin(QObject *parent)
    : QObject(parent)
{
}

QString BuzzerDiagnosticPlugin::pluginId() const
{
    return QStringLiteral("diag.buzzer");
}

QString BuzzerDiagnosticPlugin::displayName() const
{
    return QStringLiteral("Buzzer Diagnostic");
}

QString BuzzerDiagnosticPlugin::version() const
{
    return QStringLiteral("1.0.0");
}

QString BuzzerDiagnosticPlugin::componentType() const
{
    return QStringLiteral("tps.buzzer");
}

DiagnosticReport BuzzerDiagnosticPlugin::diagnose(const DiagnosticInput &input, QString *error) const
{
    ...
    QStringList lines;
    lines.push_back(QStringLiteral("buzzer diagnostic framework created."));
