#include "relaydiagnosticplugin.h"
...
RelayDiagnosticPlugin::RelayDiagnosticPlugin(QObject *parent)
    : QObject(parent)
{
}

QString RelayDiagnosticPlugin::pluginId() const
{
    return QStringLiteral("diag.relay");
}

QString RelayDiagnosticPlugin::displayName() const
{
    return QStringLiteral("Relay Diagnostic");
}

QString RelayDiagnosticPlugin::version() const
{
    return QStringLiteral("1.0.0");
}

QString RelayDiagnosticPlugin::componentType() const
{
    return QStringLiteral("tps.relay");
}

DiagnosticReport RelayDiagnosticPlugin::diagnose(const DiagnosticInput &input, QString *error) const
{
    ...
    QStringList lines;
    lines.push_back(QStringLiteral("relay diagnostic framework created."));
