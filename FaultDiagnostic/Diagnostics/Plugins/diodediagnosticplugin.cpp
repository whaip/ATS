#include "diodediagnosticplugin.h"
...
DiodeDiagnosticPlugin::DiodeDiagnosticPlugin(QObject *parent)
    : QObject(parent)
{
}

QString DiodeDiagnosticPlugin::pluginId() const
{
    return QStringLiteral("diag.diode");
}

QString DiodeDiagnosticPlugin::displayName() const
{
    return QStringLiteral("Diode Diagnostic");
}

QString DiodeDiagnosticPlugin::version() const
{
    return QStringLiteral("1.0.0");
}

QString DiodeDiagnosticPlugin::componentType() const
{
    return QStringLiteral("tps.diode");
}

DiagnosticReport DiodeDiagnosticPlugin::diagnose(const DiagnosticInput &input, QString *error) const
{
    ...
    QStringList lines;
    lines.push_back(QStringLiteral("diode diagnostic framework created."));
