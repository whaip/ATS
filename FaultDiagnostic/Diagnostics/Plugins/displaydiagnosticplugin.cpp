#include "displaydiagnosticplugin.h"
...
DisplayDiagnosticPlugin::DisplayDiagnosticPlugin(QObject *parent)
    : QObject(parent)
{
}

QString DisplayDiagnosticPlugin::pluginId() const
{
    return QStringLiteral("diag.display");
}

QString DisplayDiagnosticPlugin::displayName() const
{
    return QStringLiteral("Display Diagnostic");
}

QString DisplayDiagnosticPlugin::version() const
{
    return QStringLiteral("1.0.0");
}

QString DisplayDiagnosticPlugin::componentType() const
{
    return QStringLiteral("tps.display");
}

DiagnosticReport DisplayDiagnosticPlugin::diagnose(const DiagnosticInput &input, QString *error) const
{
    ...
    QStringList lines;
    lines.push_back(QStringLiteral("display diagnostic framework created."));
