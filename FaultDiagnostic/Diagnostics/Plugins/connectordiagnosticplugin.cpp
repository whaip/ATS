#include "connectordiagnosticplugin.h"
...
ConnectorDiagnosticPlugin::ConnectorDiagnosticPlugin(QObject *parent)
    : QObject(parent)
{
}

QString ConnectorDiagnosticPlugin::pluginId() const
{
    return QStringLiteral("diag.connector");
}

QString ConnectorDiagnosticPlugin::displayName() const
{
    return QStringLiteral("Connector Diagnostic");
}

QString ConnectorDiagnosticPlugin::version() const
{
    return QStringLiteral("1.0.0");
}

QString ConnectorDiagnosticPlugin::componentType() const
{
    return QStringLiteral("tps.connector");
}

DiagnosticReport ConnectorDiagnosticPlugin::diagnose(const DiagnosticInput &input, QString *error) const
{
    ...
    QStringList lines;
    lines.push_back(QStringLiteral("connector diagnostic framework created."));
