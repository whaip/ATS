#include "clockdiagnosticplugin.h"
...
ClockDiagnosticPlugin::ClockDiagnosticPlugin(QObject *parent)
    : QObject(parent)
{
}

QString ClockDiagnosticPlugin::pluginId() const
{
    return QStringLiteral("diag.clock");
}

QString ClockDiagnosticPlugin::displayName() const
{
    return QStringLiteral("Clock Diagnostic");
}

QString ClockDiagnosticPlugin::version() const
{
    return QStringLiteral("1.0.0");
}

QString ClockDiagnosticPlugin::componentType() const
{
    return QStringLiteral("tps.clock");
}

DiagnosticReport ClockDiagnosticPlugin::diagnose(const DiagnosticInput &input, QString *error) const
{
    ...
    QStringList lines;
    lines.push_back(QStringLiteral("clock diagnostic framework created."));
