#include "fusediagnosticplugin.h"
...
FuseDiagnosticPlugin::FuseDiagnosticPlugin(QObject *parent)
    : QObject(parent)
{
}

QString FuseDiagnosticPlugin::pluginId() const
{
    return QStringLiteral("diag.fuse");
}

QString FuseDiagnosticPlugin::displayName() const
{
    return QStringLiteral("Fuse Diagnostic");
}

QString FuseDiagnosticPlugin::version() const
{
    return QStringLiteral("1.0.0");
}

QString FuseDiagnosticPlugin::componentType() const
{
    return QStringLiteral("tps.fuse");
}

DiagnosticReport FuseDiagnosticPlugin::diagnose(const DiagnosticInput &input, QString *error) const
{
    ...
    QStringList lines;
    lines.push_back(QStringLiteral("fuse diagnostic framework created."));
